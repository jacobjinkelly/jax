...
def _dot_general_batch_rule(batched_args, batch_dims, dimension_numbers,
  ...
  # - other dimensions appear in the result and one of lhs or rhs
  ...
  if lbd is not None and rbd is not None:
    ...
    if lbd is not None:
      ...
      # rhs other dims in result come after batch dims + lhs other dims
